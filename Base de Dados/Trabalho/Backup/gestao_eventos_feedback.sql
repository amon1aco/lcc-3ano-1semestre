...
CREATE TABLE `feedback` (
  ...
  KEY `Cliente_ID_Evento` (`Cliente_ID_Feedback`),
  KEY `Evento_ID_Cliente` (`Evento_ID_Feedback`),
  CONSTRAINT `Cliente_ID_Evento` FOREIGN KEY (`Cliente_ID_Feedback`) REFERENCES `cliente` (`ID`),
  CONSTRAINT `Evento_ID_Cliente` FOREIGN KEY (`Evento_ID_Feedback`) REFERENCES `evento` (`ID`)
